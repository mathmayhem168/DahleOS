/* =============================================================
   drivers/font.c  —  8x8 monospace bitmap font (ASCII 0x20-0x7E)
   Each row is one byte; bit 7 = leftmost pixel, bit 0 = rightmost.
   Based on the classic IBM PC 8x8 ROM font (public domain).
   ============================================================= */
#include "font.h"

const uint8_t font8x8[FONT_COUNT][FONT_HEIGHT] = {
/*0x20 ' '*/ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
/*0x21 '!'*/ {0x18,0x18,0x18,0x18,0x18,0x00,0x18,0x00},
/*0x22 '"'*/ {0x66,0x66,0x24,0x00,0x00,0x00,0x00,0x00},
/*0x23 '#'*/ {0x36,0x36,0x7F,0x36,0x7F,0x36,0x36,0x00},
/*0x24 '$'*/ {0x0C,0x3F,0x03,0x1E,0x30,0x3F,0x0C,0x00},
/*0x25 '%'*/ {0x63,0x33,0x18,0x0C,0x06,0x33,0x63,0x00},
/*0x26 '&'*/ {0x1C,0x36,0x1C,0x6E,0x3B,0x33,0x6E,0x00},
/*0x27 '\''*/{0x18,0x18,0x0C,0x00,0x00,0x00,0x00,0x00},
...
/*0x79 'y'*/ {0x00,0x00,0x33,0x33,0x3E,0x30,0x1F,0x00},
